...
<body>
    ...
    <section class="workouts-section">
        <div class="workout-box">
            ...
            <a href="fullbeg.php" class="start-button">Start Now</a>
        </div>
        ...
        <div class="workout-box">
            ...
            <a href="upperbeg.php" class="start-button">Start Now</a>
        </div>
        ...
        <div class="workout-box">
            ...
            <a href="lowerbeg.php" class="start-button">Start Now</a>
        </div>
    </section>
    ...
    <section class="workouts-section">
        <div class="workout-box">
            ...
            <a href="armbeg.php" class="start-button">Start Now</a>
        </div>
        ...
        <div class="workout-box">
            ...
            <a href="legbeg.php" class="start-button">Start Now</a>
        </div>
        ...
        <div class="workout-box">
            ...
            <a href="corebeg.php" class="start-button">Start Now</a>
        </div>
    </section>
    ...
    <section class="workouts-section">
        <div class="workout-box">
            ...
            <a href="backbeg.php" class="start-button">Start Now</a>
        </div>
        ...
        <div class="workout-box">
            ...
            <a href="cardiobeg.php" class="start-button">Start Now</a>
        </div>
