...
<head>
    ...
    <nav class="navbar">
        ...
        <ul class="nav-links">
            ...
            <li><a href="step_counter.php#leaderboardBody">Go to Leaderboard</a></li> <!-- Add leaderboard link -->
        </ul>
    </nav>
</head>
<body>
    ...
    <audio id="completionSound" src="relax.wav"></audio>

    <script src="normalexpert.js"></script>
</body>
</html>
