...
<body>
    ...
    <header class="header-section">
        <h1>Start Strong: A Intermediate's Path to Fitness</h1>
    ...
    <section class="workouts-section">
        <div class="workout-box">
            ...
            <a href="wfullinter.php" class="start-button">Start Now</a>
        </div>
        ...
        <div class="workout-box">
            ...
            <a href="wupperinter.php" class="start-button">Start Now</a>
        </div>
        ...
        <div class="workout-box">
            ...
            <a href="wlowerinter.php" class="start-button">Start Now</a>
        </div>
    </section>
    ...
    <section class="workouts-section">
        <div class="workout-box">
            ...
            <a href="warminter.php" class="start-button">Start Now</a>
        </div>
        ...
        <div class="workout-box">
            ...
            <a href="wleginter.php" class="start-button">Start Now</a>
        </div>
        ...
        <div class="workout-box">
            ...
            <a href="wcoreinter.php" class="start-button">Start Now</a>
        </div>
    </section>
    ...
    <section class="workouts-section">
        <div class="workout-box">
            ...
            <a href="wbackinter.php" class="start-button">Start Now</a>
        </div>
        ...
        <div class="workout-box">
            ...
            <a href="wcardiointer.php" class="start-button">Start Now</a>
        </div>
