...
<body>
    ...
    <section class="workouts-section">
        <div class="workout-box">
            ...
            <a href="wfullexpert.php" class="start-button">Start Now</a>
        </div>
        ...
        <div class="workout-box">
            ...
            <a href="wupperexpert.php" class="start-button">Start Now</a>
        </div>
        ...
        <div class="workout-box">
            ...
            <a href="wlowerexpert.php" class="start-button">Start Now</a>
        </div>
    </section>
    ...
    <section class="workouts-section">
        <div class="workout-box">
            ...
            <a href="warmexpert.php" class="start-button">Start Now</a>
        </div>
        ...
        <div class="workout-box">
            ...
            <a href="wlegexpert.php" class="start-button">Start Now</a>
        </div>
        ...
        <div class="workout-box">
            ...
            <a href="wcoreexpert.php" class="start-button">Start Now</a>
        </div>
    </section>
    ...
    <section class="workouts-section">
        <div class="workout-box">
            ...
            <a href="wbackexpert.php" class="start-button">Start Now</a>
        </div>
        ...
        <div class="workout-box">
            ...
            <a href="wcardioexpert.php" class="start-button">Start Now</a>
        </div>
