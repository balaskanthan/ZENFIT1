                ...
                <div class="col-lg-6">
                    <nav class="nav-menu">
                        <ul>
                            ...
                            <li><a href="about-us.php">About Us</a></li>
                            <li><a href="step_counter.php#leaderboardBody">Leaderboard challenge</a></li>
                            <li><a href="workout.php">Workouts</a></li>
                            <li><a href="team.php">Our Team</a></li>
                            <li><a href="#">Pages</a>
                                <ul class="dropdown">
                                    ...
                                    <li><a href="step_counter.php#leaderboardBody">Leaderboard</a></li>
                                    <li><a href="#">Normal Workouts</a></li>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <p>
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Made with <i class="fa fa-heart" aria-hidden="true"></i> by <a>Balaskanthan AK</a>
  </p>
                    </div>
                </div>
            </div>
