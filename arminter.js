...
const countdownStart = 60;  // Starting countdown time in seconds

const videos = [
    'Barbell-Bicep-Curl.mp4',
    'Dumbbell-Tricep-Kickback.mp4',
    'Cable-Tricep-Pushdown.mp4',
    'Dumbbell-Hammer-Curl.mp4',
    'Cable-Bent-Over-Crossover.mp4',
    'Cable-Overhead-Tricep-Extension.mp4',
    'Dumbbell-Incline-Hammer-Curl.mp4',
...
generateExerciseBoxes(12);  // Generate 5 exercises