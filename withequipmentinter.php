...
<body>
    ...
    <section class="workouts-section">
        <div class="workout-box">
            ...
            <a href="fullinter.php" class="start-button">Start Now</a>
        </div>
        ...
        <div class="workout-box">
            ...
            <a href="upperinter.php" class="start-button">Start Now</a>
        </div>
        ...
        <div class="workout-box">
            ...
            <a href="lowerinter.php" class="start-button">Start Now</a>
        </div>
    </section>
    ...
    <section class="workouts-section">
        <div class="workout-box">
            ...
            <a href="arminter.php" class="start-button">Start Now</a>
        </div>
        ...
        <div class="workout-box">
            ...
            <a href="leginter.php" class="start-button">Start Now</a>
        </div>
        ...
        <div class="workout-box">
            ...
            <a href="coreinter.php" class="start-button">Start Now</a>
        </div>
    </section>
    ...
    <section class="workouts-section">
        <div class="workout-box">
            ...
            <a href="backinter.php" class="start-button">Start Now</a>
        </div>
        ...
        <div class="workout-box">
            ...
            <a href="cardiointer.php" class="start-button">Start Now</a>
        </div>
