...
const exercises = [
    ...
    // Main Exercises
    { name: "Burpees", duration: 120, calories: 15, video: "burpees.mp4" },
    { name: "Mountain Climbers", duration: 90, calories: 13, video: "mountainclimbing.mp4" },
    { name: "Forward Lunges", duration: 120, calories: 9, video: "forwardlunges.mp4" },
    { name: "Bicycle Crunches", duration: 90, calories: 10, video: "bicyclecrunches.mp4" },
    { name: "Tricep Dips", duration: 100, calories: 10, video: "tricepsdips.mp4" },
    { name: "Knee Thrusts Right", duration: 90, calories: 8, video: "kneethrustsleft.mp4" },
    { name: "Knee Thrusts Left", duration: 90, calories: 8, video: "kneethrustsright.mp4" },
    { name: "Jump Rope", duration: 300, calories: 22, video: "skip.mp4" },
    { name: "Flutter Kicks", duration: 120, calories: 8, video: "flutterkicks.mp4" },
    { name: "Bow Pose Stretching", duration: 60, calories: 3, video: "bow.mp4" },
    { name: "Push-Ups", duration: 60, calories: 8, video: "pushups.mp4" },
    { name: "High Knees", duration: 120, calories: 15, video: "highknee.mp4" },

    // Relaxation
    { name: "Child's Pose", duration: 60, calories: 4, video: "child.mp4" },
