...
<body>
    ...
    <header class="header-section">
        <h1>Start Strong: A Beginner's Path to Fitness</h1>
    ...
    <section class="workouts-section">
        <div class="workout-box">
            ...
            <a href="wfullbeg.php" class="start-button">Start Now</a>
        </div>
        ...
        <div class="workout-box">
            ...
            <a href="wupperbeg.php" class="start-button">Start Now</a>
        </div>
        ...
        <div class="workout-box">
            ...
            <a href="wlowerbeg.php" class="start-button">Start Now</a>
        </div>
    </section>
    ...
    <section class="workouts-section">
        <div class="workout-box">
            ...
            <a href="warmbeg.php" class="start-button">Start Now</a>
        </div>
        ...
        <div class="workout-box">
            ...
            <a href="wlegbeg.php" class="start-button">Start Now</a>
        </div>
        ...
        <div class="workout-box">
            ...
            <a href="wcorebeg.php" class="start-button">Start Now</a>
        </div>
    </section>
    ...
    <section class="workouts-section">
        <div class="workout-box">
            ...
            <a href="wbackbeg.php" class="start-button">Start Now</a>
        </div>
        ...
        <div class="workout-box">
            ...
            <a href="wcardiobeg.php" class="start-button">Start Now</a>
        </div>
